...
#### Temporal Encoding
Temporal encoding is when the precise timing of spikes in a given time interval or the time between spikes is considered to carry information rather than the number of spikes generated by the neuron.

In this particular example, the intensity of the pixel value is inversely proportional to when the neuron spikes in the 33 ms time interval.
![TimeEncoding](https://user-images.githubusercontent.com/13342705/59804662-014fec00-92bd-11e9-9f86-845bd13da8cd.PNG)

The visual and olfactory systems seem to encode information this way. This method is also computationally efficient compared to rate encoding mechanisms.
...
* “Neural Coding.” Wikipedia, Wikimedia Foundation, 21 May 2019, en.wikipedia.org/wiki/Neural_coding#cite_note-19.